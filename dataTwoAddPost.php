...
<div>
    <div class="alert alert-success"> New Drink Added</div>
</div>
...
<div>
    ...
    <?php
        ...
        $cost = $_POST['drinkCost'];
        $temp = $_POST['drinkTemperature'];

        // prepare and bind
        $sql = "INSERT INTO Drink (drinkName, drinkCost, drinkTemperature) VALUES (?, ?, ?)";
